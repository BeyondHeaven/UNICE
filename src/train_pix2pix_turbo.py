...
def main(args):
    ...
    if args.pretrained_model_name_or_path == "stabilityai/sd-turbo":
        net_pix2pix = Pix2Pix_Turbo(lora_rank_unet=args.lora_rank_unet, lora_rank_vae=args.lora_rank_vae, pretrained_path=args.model_path)
    ...
    # Remove LPIPS and CLIP initialization
    ...
    dataset_train = PairedDataset(dataset_folder=args.dataset_folder, image_prep=args.train_image_prep, tokenizer=net_pix2pix.tokenizer)
    ...
    # Remove preparation for LPIPS and CLIP
        ...
        for step, batch in enumerate(dl_train):
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    # Remove LPIPS and CLIP similarity loss logging
                    ...
                    #     # Remove LPIPS and CLIP similarity logging
